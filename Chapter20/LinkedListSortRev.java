...
public class LinkedListSortRev {
    ...
    public static void reverse(LinkedListSortRev sourceList){
    ...
    public static void sort(LinkedListSortRev sourceList) {
